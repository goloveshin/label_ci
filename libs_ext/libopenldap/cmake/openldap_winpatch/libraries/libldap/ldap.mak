...
CPP=cl.exe
CPP_PROJ=$(APPEND_CPPFLAGS) /nologo /MD /W3 /Zi /O2 /Oy- /I "./../../include" /D "_CRT_SECURE_NO_WARNINGS" /D "NDEBUG" /D "_WIN32" /D "WIN32" /D "WINNT" /D "_WINNT" /D "LDAP_LIBRARY" /Fo"$(INTDIR)\\" /Fd"$(OUTDIR)\ldap" /FD /c 
RSC=rc.exe
LIB32=link.exe -lib
...
CPP=cl.exe
CPP_PROJ=$(APPEND_CPPFLAGS) /nologo /MDd /W3 /Zi /Od /I "./../../include" /D "_CRT_SECURE_NO_WARNINGS" /D "_DEBUG" /D "LDAP_DEBUG" /D "_WIN32" /D "WIN32" /D "WINNT" /D "_WINNT" /D "LDAP_LIBRARY" /Fo"$(INTDIR)\\" /Fd"$(OUTDIR)\ldap" /FD /EHsc /c 
RSC=rc.exe
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"$(OUTDIR)\ldap.lib" 
LIB32_OBJS= \

...
CPP=cl.exe
CPP_PROJ=$(APPEND_CPPFLAGS) /nologo /MD /W3 /Zi /O2 /Oy- /I "./../../include" /D "_CRT_SECURE_NO_WARNINGS" /D "NDEBUG" /D "_WIN32" /D "WIN32" /D "WINNT" /D "_WINNT" /D "_WINDOWS" /D "LBER_LIBRARY" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\liblber_src" /FD /c 
RSC=rc.exe
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\liblber.res" /I "./../../include" /d "NDEBUG"
LINK32=link.exe
LINK32_FLAGS=$(APPEND_LDFLAGS) kernel32.lib ws2_32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\liblber.pdb" /debug /out:"$(OUTDIR)\liblber.dll" /def:"$(DEF_FILE)" /implib:"$(OUTDIR)\liblber.lib" /MACHINE:X86 /opt:ref 
LINK32_OBJS= \
	"$(INTDIR)\assert.obj" \
	"$(INTDIR)\bprint.obj" \
	"$(INTDIR)\debug.obj" \
...
CPP=cl.exe
CPP_PROJ=$(APPEND_CPPFLAGS) /nologo /MDd /W3 /Zi /Od /I "./../../include" /D "_CRT_SECURE_NO_WARNINGS" /D "_DEBUG" /D "LDAP_DEBUG" /D "_WIN32" /D "WIN32" /D "WINNT" /D "_WINNT" /D "_WINDOWS" /D "LBER_LIBRARY" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\liblber_src" /FD /EHsc /c 
RSC=rc.exe
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\liblber.res" /I "./../../include" /d "_DEBUG"
LINK32=link.exe
LINK32_FLAGS=$(APPEND_LDFLAGS) kernel32.lib ws2_32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\liblber.pdb" /debug /out:"$(OUTDIR)\liblber.dll" /def:"$(DEF_FILE)" /implib:"$(OUTDIR)\liblber.lib" /MACHINE:X86 
LINK32_OBJS= \
	"$(INTDIR)\assert.obj" \
	"$(INTDIR)\bprint.obj" \
	"$(INTDIR)\debug.obj" \
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\liblber.res" /I "./../../include" /d "NDEBUG"
LINK32=link.exe
LINK32_FLAGS=$(APPEND_LDFLAGS) kernel32.lib ws2_32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\liblber.pdb" /debug /out:"$(OUTDIR)\liblber.dll" /def:"$(DEF_FILE)" /implib:"$(OUTDIR)\liblber.lib" /MACHINE:X64 /opt:ref 
LINK32_OBJS= \
	"$(INTDIR)\assert.obj" \
	"$(INTDIR)\bprint.obj" \
	"$(INTDIR)\debug.obj" \
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\liblber.res" /I "./../../include" /d "_DEBUG"
LINK32=link.exe
LINK32_FLAGS=$(APPEND_LDFLAGS) kernel32.lib ws2_32.lib /nologo /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\liblber.pdb" /debug /out:"$(OUTDIR)\liblber.dll" /def:"$(DEF_FILE)" /implib:"$(OUTDIR)\liblber.lib" /MACHINE:X64 
LINK32_OBJS= \
	"$(INTDIR)\assert.obj" \
	"$(INTDIR)\bprint.obj" \
	"$(INTDIR)\debug.obj" \

...
elseif (CMAKE_BUILD_TYPE MATCHES RelWithDebInfo)
    set(BUILD_MODE   "-release" "-force-debug-info")
endif ()


if (CLIENT_FOR_WINDOWS_32 OR CLIENT_FOR_WINDOWS_64)

    set(MAKE_TOOL "-make-tool" "jom")
...
elseif (CLIENT_FOR_LINUX_32)
    ...
    set(MAKE_TOOL "")
    set(PLATFORM "linux-g++-32")
    set(XCB "-qt-xcb")
    set(GTKSTYLE "-gtkstyle")
    set(FONTCONFIG "-fontconfig")
    set(FREETYPE "-system-freetype")

elseif (CLIENT_FOR_LINUX_64)

    set(MAKE_TOOL "")
    set(PLATFORM "linux-g++-64")
    set(XCB "-qt-xcb")
    set(GTKSTYLE "-gtkstyle")
    set(FONTCONFIG "-fontconfig")
    set(FREETYPE "-system-freetype")
...
set(CONFIGURE_PARAMS_LIST
    ...
    #                          (default /usr/local/Qt-5.6.3, $PWD if -developer-build is active)
    "-prefix" "${INSTALL_DIR}"
    ...
    "-openssl-linked"
    "-I" "${LIB__OPENSSL__INCLUDE_DIR}"
    "-L" "${LIB__OPENSSL__LIBRARY_DIR}"
    ...
    "-icu"
    "-I" "${LIB__ICU__INCLUDE_DIR}"
    "-L" "${LIB__ICU__LIBRARY_DIR}"
